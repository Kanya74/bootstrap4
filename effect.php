    ...
    <main role="main">
      ...
      <div class="container text-center">
        ...
        <div class="row mt-4">
          ...
          <div class="row">
            <div class="col-md-6">
              <img src="img/Chrysanthemum.jpg" class="img-fluid" alt="" id="pic1">
              <button class="btn btn-lg btn-info mt-4" id="btnadd">Add Class</button>
            </div>
              <div class="col-md-6">
              <img src="img/Desert.jpg" class="img-fluid imgcircle" alt="" id="pic2">
              <button class="btn btn-lg btn-info mt-4" id="btnremove">Remove</button>
            </div> 
          </div>
          <div class="row">
            <div class="col-md-12">
               <h2 class="text center">Swith class</h2>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="divtext">
               <p class="abzac">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci molestiae ad, in laudantium nesciunt autem blanditiis harum nam odio assumenda debitis dignissimos repudiandae reprehenderit dolore quo qui suscipit quas quibusdam.
                </p> 
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="anim">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor nobis facilis blanditiis, iste sequi numquam, cupiditate sint id voluptate quae.</div>
