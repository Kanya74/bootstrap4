...
<div class="container mt-4"> 
  <div class="row mt-4">
    <div class="col-md-12">
      ...
      <div class="col-md-4">
      <img src="img/Chrysanthemum.jpg" id="kart1" class="img-fluid" alt="">
    </div>
    <div class="col-md-4">
      <img src="img/Desert.jpg" id="kart2" class="img-fluid" alt="">
    </div>
      <div class="col-md-4">
      <img src="img/Hydrangeas.jpg" id="kart3" class="img-fluid" alt="">
    </div>
    </div>
    <div class="row-mt-4">
      <div class="col-md-12">
